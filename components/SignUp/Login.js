        ...
        <div className="flex overflow-hidden relative flex-col justify-center items-center py-56  w-full max-md:px-5 max-md:max-w-full">
          ...
          <div className="py-2 relative">
            <div className="py-2 bg-white rounded-lg">
              <div className="px-2">
                <h1 className="w-8 h-8 rounded-full"></h1>
                <div>
                ...
                <div>
                  ...
                  <button className="flex items-center w-full justify-center bg-gray-300 rounded-md py-2 px-4 mt-2 gap-2" onClick={googleSignIn}>
