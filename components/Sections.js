    ...
    <div className="flex overflow-hidden relative flex-col justify-center items-center px-16  font-semibold text-center h-[400px] max-md:px-5">
      ...
      <div className="flex flex-col md:flex-row relative justify-items-start container mx-auto max-w-6xl gap-2 ">
        ...
        <div className="w-full">
          ...
          {/* hadith */}
          <div>
            <h1 className="text-gray-400 text-sm container mx-auto max-w-2xl mt-5">
              "আবূ হুরায়রা (রাঃ) থেকে বর্ণিত, আল্লাহর দূত (সাল্লাল্লাহু আলাইহি
              ওয়াসাল্লাম) বলেন, 'রমজান মাস আসে, তখন আকাশের দরজা খুলে দেওয়া হয়
              এবং জাহান্নামের দরজা বন্ধ হয়ে যায় এবং শয়তানরা শোষিত হয়ে যায়।'
              (সহীহ আল-বুখারী ১৮৯৯)
            </h1>
          </div>
        </div>
